...
DetGammaEMPhysics::DetGammaEMPhysics(const G4String& name)
...
DetGammaEMPhysics::~DetGammaEMPhysics() {}
...
void DetGammaEMPhysics::ConstructParticle()
{
  // gamma
...
void DetGammaEMPhysics::ConstructProcess()
{
